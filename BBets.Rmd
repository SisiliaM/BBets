...
The lower end is `r lcl` to the upper end `r ucl`. If Brownlow was to give out a 2:1 bets the lower end would be `r lcl` and the upper end would be `r ucl`. This is not a fair bet because he will consantly keep making money. 
